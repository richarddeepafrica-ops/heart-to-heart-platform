...
const protectedApiPrefixes = ["/api/beneficiaries", "/api/event-registrations", "/api/marketing-campaigns"];
...
export const config = {
  matcher: ["/admin/:path*", "/api/beneficiaries/:path*", "/api/event-registrations/:path*", "/api/campaigns/:path*", "/api/marketing-campaigns/:path*"]
};
