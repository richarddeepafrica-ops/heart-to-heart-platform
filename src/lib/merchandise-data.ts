...
const previewProducts: MerchandiseProductRecord[] = [
  {
    ...
    imageUrl: "/assets/shop/heart-run-t-shirt.png",
    price: 1500,
    stockQuantity: 120,
    status: "ACTIVE",
    featured: true,
  ...
  },
  {
    ...
    imageUrl: "/assets/shop/foundation-cap.png",
    price: 900,
    stockQuantity: 80,
    status: "ACTIVE",
    featured: false,
  ...
  },
  {
    ...
    imageUrl: "/assets/shop/heart-run-water-bottle.png",
    price: 1200,
    stockQuantity: 60,
    status: "ACTIVE",
    featured: false,
  ...
  },
  {
    ...
    imageUrl: "/assets/shop/supporter-tote-bag.png",
    price: 1800,
    stockQuantity: 45,
    status: "ACTIVE",
    featured: true,
